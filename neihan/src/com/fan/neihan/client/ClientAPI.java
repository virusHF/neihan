...
public class ClientAPI {
	 ...
	 * @see #CATEGROY_IMG
	 */
	public static void getList(RequestQueue queue, int categroy_type,
			int itemcount, Response.Listener<String> listener) {
		...
		String url = TestActivity.CATEGROY_LIST_URI
